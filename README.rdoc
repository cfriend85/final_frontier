Javascript React project calling on NASA's astronomy picture of the day API for the main hero image as well as calls on The Solar System Open Data to populate
